...
class KFACBaseLayer:
        ...
        *,
        ...
        Args:
            ...
            symmetry_aware (bool): use symmetry aware communication method.
                ...
                large (default: False).
        """
        self.module_helper : ModuleHelper = module_helper
        self.tdc = tdc
        ...
        self.name = "layer"
        self.layer_type = module_helper.__class__.__name__
        if module_helper.__class__.__name__ == "LinearModuleHelper":
            self.layer_type = 'linear' 
        elif module_helper.__class__.__name__ == "Conv2dModuleHelper":
            self.layer_type = 'conv2d'

    def __repr__(self) -> str:
        """Representation of KFACBaseLayer."""
        return f'{self.__class__.__name__}({repr(self.module_helper)})'
    ...
    def load_state_dict(
        ...
        device = self.module_helper.device
    ...
    def update_grad(self, scale: float | None = None) -> None:
        ...
        if scale is not None:
            grad = scale * grad
        self.module_helper.set_grad(grad)
        self.grad = None
